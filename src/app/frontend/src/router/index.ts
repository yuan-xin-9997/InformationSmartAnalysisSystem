...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'analysis-tasks', component: () => import('@/views/AnalysisTasks.vue'), meta: { page: 'analysis_tasks', title: '任务分析' } },
      ...
      { path: 'scheduled-jobs', redirect: '/analysis-tasks' },
      { path: 'push-management', redirect: '/analysis-tasks' },
