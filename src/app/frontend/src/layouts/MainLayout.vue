...
const allMenus = [
  ...
  { path: '/scheduled-jobs', icon: '定', page: 'scheduled_jobs', title: '定时任务' },
  { path: '/task-center', icon: '务', page: 'task_center', title: '任务中心' },
  { path: '/push-management', icon: '推', page: 'push_management', title: '推送管理' },
...
const pageMeta: Record<string, [string, string]> = {
  ...
  scheduled_jobs: ['定时任务', '为分析任务配置定时调度，自动触发分析'],
  task_center: ['任务中心', '查看同步与分析任务运行状态及日志'],
  push_management: ['推送管理', '配置推送规则与 SMTP，把增量分析结果推送到邮箱'],
